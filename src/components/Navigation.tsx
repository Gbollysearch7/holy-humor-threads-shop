      ...
      <div className="container mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          ...
          <div className="hidden md:flex items-center space-x-8 animate-fade-in">
            <a href="#" className="text-foreground/80 hover:text-holy-blue dark:hover:text-holy-gold transition-all duration-300 font-medium hover:scale-105">
              Shop
            </a>
            <a href="#" className="text-foreground/80 hover:text-holy-blue dark:hover:text-holy-gold transition-all duration-300 font-medium hover:scale-105">
              About
        ...
        <div className={`md:hidden transition-all duration-300 ease-in-out ${
          ...
          <div className="flex flex-col space-y-4">
            <a href="#" className="text-foreground/80 hover:text-holy-blue dark:hover:text-holy-gold transition-all duration-300 font-medium transform hover:translateX-2">
              Shop
            </a>
            <a href="#" className="text-foreground/80 hover:text-holy-blue dark:hover:text-holy-gold transition-all duration-300 font-medium transform hover:translateX-2">
              About
